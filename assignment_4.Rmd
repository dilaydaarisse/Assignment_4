...
# The p-value is 0.06871. This means that, assuming a null hypothesis that there is no difference in the mean growth rates between the two groups defined by the treat variable, the probability of observing a t-statistic as extreme or more extreme than the observed t-statistic is 0.06871.
...
# The variable rgp60 is the value of GDP per capita in 1960, converted to 1960 US dollars. It's purpose is to be able to measure other variables by holding rgdp60 constant, for the growth of country.
...
# According to this analysis the main driver of economic growth is tradeshare, when growth changes by 1 tradeshare increases by 2.233 (in model 3) and by 1.813 (in model 4), the other variables have less or no effect.
